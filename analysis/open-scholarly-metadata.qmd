## Working with open scholarly metadata
```r
...
# Abstracts are too messy and inconsistent, and it's a pain to deal with html tags.
```
...
I'm missing a step here, from my previous work several months ago.
Need to find the code that generated `seed_refs_bib`.
